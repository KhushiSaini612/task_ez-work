...
import about_topLeft from "../assets/about_topLeft.png"; // 🔸 tilted paper 1
import scenery from "../assets/scenery.png"; // 🔸 bottom background image
import outline from "../assets/outline.png"; // 🔸 text-over-image
